...
# /en/1.11/ref/settings/#auth-password-validators
...
DYNAMIC_PREFERENCES = {
    ...
    # a python attribute that will be added to model instances
    # with preferences
    ...
    # WARNING: enabling this feature can cause data corruption if multiple
    # users use the same list view at the same time
    # see https://code.djangoproject.com/ticket/11313
    'ADMIN_ENABLE_CHANGELIST_FORM': True,

    # Customize how you can access preferences from managers.
    # The default is to separate sections and keys with two underscores.
    # This is probably not a settings you'll want to change,
